...
export const ContactSection = () => {
  ...
  return <section id="contact" className="bg-gradient-to-b from-glucose-50/30 to-white py-0">
          ...
          <div className="md:col-span-2 animate-fade-in">
            <div className="glass-card p-15 px-[60px] py-[40px]">
              <div className="flex justify-center mb-6">
                <img alt="Glucose Control Research Logo" className="w-100 h-40 object-contain" src="/lovable-uploads/94d02c19-eb94-480c-a81f-06f80c5b0cb8.png" />
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Our code and research are available here:{" "}
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-glucose-700">
                      christopher.risi@uwaterloo.ca
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 py-0">
                      200 University Ave W, Waterloo, ON N2L 5Z5
                    </p>
                  </div>
                </div>
              </div>
