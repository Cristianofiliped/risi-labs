...
const researchAreas = [
  {
    icon: <Search className="w-12 h-12 text-glucose-600" />,
  ...
  {
    icon: <Beaker className="w-12 h-12 text-glucose-600" />,
  ...
  {
    icon: <TestTube className="w-12 h-12 text-glucose-600" />,
  ...
  {
    icon: <Activity className="w-12 h-12 text-glucose-600" />,
...
export const ResearchSection = () => {
  return (
    <section id="research" className="bg-gradient-to-b from-white to-glucose-50/30 py-12">
        ...
        <div className="space-y-16">
          {researchAreas.map((area, index) => (
            <div 
              key={index} 
              className={cn(
                "grid md:grid-cols-2 gap-8 items-center animate-fade-in",
            ...
            >
              ...
              <div className={cn(
                "order-1 aspect-square bg-glucose-50 rounded-xl flex items-center justify-center relative overflow-hidden",
                index % 2 === 1 ? "md:order-2" : "md:order-1"
              )}>
                <div className="w-32 h-32 rounded-full bg-glucose-200 flex items-center justify-center">
                  {area.icon}
                </div>
