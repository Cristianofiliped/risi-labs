...
export const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center">
      ...
      <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-glucose-100/30 rounded-full filter blur-3xl animate-pulse-gentle" style={{ animationDelay: "1s" }}></div>
      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl">
          ...
          <h1 className="mt-6 text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 leading-tight animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Simplifying Diabetes Management with{" "}
            <span className="text-glucose-600">Machine Learning</span>
          </h1>
          
          <p className="mt-6 text-xl text-gray-600 max-w-3xl animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Transforming how People with Diabetes track fitness, nutrition, and insulin use through intelligent algorithms and data-driven insights.
          </p>
          
          <div className="mt-10 flex flex-wrap gap-4 animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <button 
              onClick={scrollToAbout}
              className="bg-glucose-600 hover:bg-glucose-700 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-300 flex items-center group"
            >
              Learn More
