      ...
      <div className="section-container">
        <div className="max-w-3xl mx-auto text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-gray-600">
            Our interdisciplinary team combines expertise in machine learning, healthcare, and diabetes management to drive innovation.
          </p>
        </div>
        ...
        <div className="mt-20 bg-gradient-to-r from-glucose-50 to-blue-50 rounded-2xl overflow-hidden shadow-sm animate-fade-in">
          <div className="p-8 md:p-12 text-center">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">Join Our Research Team</h3>
            <p className="text-gray-700 mb-6 max-w-3xl mx-auto">
              We're always looking for talented researchers and engineers passionate about using AI to improve healthcare outcomes. If you're interested in our mission, reach out to explore opportunities.
            </p>
            <a 
              href="#contact" 
              className="inline-block bg-glucose-600 hover:bg-glucose-700 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-300"
            >
              Contact Us
            </a>
          </div>
